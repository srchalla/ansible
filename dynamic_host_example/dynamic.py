...
class OurInventory(object):
    ...
    def our_inventory(self):
        return {
            'group': {
                'hosts': ['srinathrchalla1.mylabserver.com', 'srinathrchalla2.mylabserver.com', 'srinathrchalla3.mylabserver.com'],
                'vars': {
                    'ansible_user': 'schalla',
                    'test_variable': 'nonspecific_value'
                }
            },
            '_meta': {
                'hostvars': {
                    'srinathrchalla1.mylabserver.com': {
                        'logs_folder': '/var/log'
                    },
                    'srinathrchalla2.mylabserver.com': {
